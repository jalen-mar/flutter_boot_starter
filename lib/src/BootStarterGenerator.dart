...
import 'package:flutter_boot/annotation/ApplicationAnnotation.dart';

class BootStarterGenerator extends GeneratorForAnnotation<AutoApplication> {
  @override
  String generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) {
    if (element is! ClassElement) {
      ...
      throw InvalidGenerationSourceError(
        ...
        todo: 'Remove the [BootStarterGenerator] annotation from `$name`.',
      );
    }
  ...
  String _createMainMethodSource(ClassElement element) {
    ...
    if (initializeMethod == null) {
      throw InvalidGenerationSourceError(
        ...
        todo: 'Remove the [AutoApplication] annotation from `${element.name}`.',
      );
    }
  ...
  String _createFeignSource(ClassElement element) {
    ...
    var feignAutoType = TypeChecker.fromRuntime(FeignAuto);
